...
const OurServices = () => {
  return (
    <div className="container mx-auto px-5 lg:px-10 py-16">
      <h2 className="text-4xl lg:text-5xl font-bold text-center mb-10 text-rose-500">
        Our Services
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#FB7185] to-[#FB7185] h-0 group-hover:h-full transition-all duration-500 ease-in-out z-0"></div>

            {/* Content including Icon */}
            <div className="relative z-10 text-center">
              <div className="mb-4 text-[#F43F5E] group-hover:text-white transition-all duration-500">
                {service.icon}
              </div>
