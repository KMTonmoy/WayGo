            ...
            <div className="bg-white bg-opacity-50 backdrop-blur-lg rounded-lg p-5 shadow-lg w-full lg:w-1/2 max-w-lg mx-auto">
              <form className="space-y-4" onSubmit={handleSearch}>
                <div>
                  ...
                  <select
                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 outline-none focus:ring-[#F43F5E]"
                    value={fromLocation}
                ...
                <button
                  type="submit"
                  className="w-full py-2 px-4 bg-[#F43F5E] text-white font-bold rounded-lg hover:bg-[#c54b3d] duration-300"
                >
                  Search
                </button>
              </form>
