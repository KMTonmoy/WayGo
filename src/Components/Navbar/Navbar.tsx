      ...
      <div className="container mx-auto flex justify-between items-center h-[100px] px-5 lg:px-10">
        ...
        <div className="flex gap-2">
          ...
          >
            <Link
              href="/login"
              className="relative inline-flex items-center justify-center px-5 py-2.5 overflow-hidden font-medium text-white transition duration-300 ease-out bg-[#f0652b] rounded-full group"
            >
