...
function WhyChooseUs() {
  return (
    // <div className="w-screen mt-96">
       
    //     <div className=' grid grid-cols-1 lg:grid-cols-2'>
    //         <div className="relative ">
    //             <div className="absolute lg:inset-0 md:-inset-0">
    //                 <Image alt="bus photo" src="/HomePage/chooseBus.jpg" layout="fill" objectFit="cover" className='relative '/>
    //             </div>
    ...
    //                 <button className='font-bold mt-4 text-sm flex justify-center items-center gap-3'>View Projects <span><FaArrowRight /></span></button>
    //             </div>
    //         </div>
    ...
    //             </div>
    //             <p className='lg:w-4/5 md:w-fit'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsum, nulla sed laudantium libero iure nihil ea vel saepe consequatur ex atque voluptatibus, fugit facere rerum sit!</p>
