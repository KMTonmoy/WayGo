      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:flex md:items-end md:justify-between">
            ...
            <a
              href="#"
              className="mt-6 inline-flex shrink-0 items-center gap-2 rounded-full border border-[--clr-primary] px-5 py-3 text-[--clr-primary] transition hover:bg-[--clr-primary] hover:text-white md:mt-0"
            >
