                ...
                {layout === "list" ? (
                  <div>
                    <div className="flex justify-around py-5 items-center gap-4">
                      <div>
                        <h3 className="text-2xl font-semibold text-[#22C55E] mb-2">{bus.busName}</h3>
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-[#22C55E]">Seat Price: {bus.seatPrice} BDT</p>
                      </div>
                  ...
                  <div>
                    <h3 className="py-2 text-center text-2xl font-semibold text-[#22C55E] mb-2">{bus.busName}</h3>
                    <div>
                      ...
                      <div className="flex flex-col items-center">
                        <p className="text-xl mb-5 font-bold text-[#22C55E]">Seat Price: {bus.seatPrice} BDT</p>
                        <Link href={`/AllBus/${bus._id}?date=${departureDate}`}>
                          <button className="px-6 py-2 bg-[#22C55E] text-white rounded-lg hover:bg-[#0ca544] transition-colors">
                            Book a Ticket
                          </button>
