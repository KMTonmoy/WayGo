            ...
            <div className="container mx-auto">
                ...
                <div className="flex justify-center mt-10">
                    <button
                        ...
                        className={`px-4 py-2 mx-1 text-white bg-gray-600 rounded ${currentPage === 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        Previous
                    </button>
                    ...
                    {Array.from({ length: totalPages }, (_, index) => (
                        <button
                            ...
                            className={`px-4 py-2 mx-1 ${currentPage === index + 1 ? 'bg-[#f0652b]' : 'bg-gray-600'} text-white rounded`}
                        >
                            {index + 1}
                        </button>
                    ))}
                    ...
                    <button
                        ...
                        className={`px-4 py-2 mx-1 text-white bg-gray-600 rounded ${currentPage === totalPages ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        Next
                    </button>
                </div>
