...
const AboutPage = () => {
  const developers = [
    ...
    },
    {
      name: 'Sobuj',
      image:
        'https://scontent.fdac138-1.fna.fbcdn.net/v/t39.30808-6/448656210_997699081913211_2341890476413512821_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeHdsOJ7iOR0gxAtrryTXS_BAzSnRdNH6iMDNKdF00fqI3qY4tTnJWS5gNWbKwCvoEyhUheiTrlGXTCu8J1Bldxq&_nc_ohc=x6chqIMqFD8Q7kNvgGCrfUj&_nc_ht=scontent.fdac138-1.fna&_nc_gid=AadhqA-9Kd9RBDMunY_CqAD&oh=00_AYDt9UxJSuX3TqyQMhkmGQrfirlS0e_zT_-9odWSLBWn3w&oe=66F84464',
      github: '#',
      linkedin: '#',
      facebook: '#',
    },
            ...
            >
              ...
              <div className="container mx-auto text-center bg-white py-12 px-6 shadow-lg rounded-lg mb-16">
                ...
                <motion.p
                  ...
                  transition={{ duration: 0.5, delay: 0.2 }}
                >
                  Welcome to WayGO, a state-of-the-art ticket management
                  platform designed to streamline your ticketing processes. Our
                  website provides users with an intuitive interface to manage,
                  track, and resolve tickets with ease. Powered by the latest
                  technologies like <strong>Next.js</strong>,{' '}
                  <strong>TypeScript</strong>, and <strong>Tailwind CSS</strong>
                  , WayGO ensures a seamless experience for users and
                ...
                >
                  Whether you are handling customer support tickets, IT service
                  requests, or general inquiries, WayGO simplifies the ticketing
                  workflow, making sure your tasks are well-organized and
                  completed efficiently. Explore the features of this powerful
                  tool and elevate your ticket management experience!
                </motion.p>
              </div>
